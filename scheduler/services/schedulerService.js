...
const getCampanas = async () => {
    try {
        const response = await axios.get('http://load-balancer:3020/api/cam/getCampanas');
...
const iniciarEnvioCampana = async (campana) => {
    try {
        await axios.post('http://load-balancer:3020/api/email/iniciarEnvioCampana', { campana });
